...
import ApiSd from '../Api/smpBackend.js';
import React, { useState } from 'react';
import { View, Text, SafeAreaView, TouchableOpacity, TextInput, StyleSheet } from 'react-native';



export default function InputSMP({ navigation }) {
    ...
    const post = async()=>{
        ...
        alert('Data Masih Ada Yang kosong')
            ...
            try {
                const p = await axios.post('http://10.0.2.2:8080/smp', {
                    "pelajaran" : pelajaran,
                    "penerbit" : penerbit,
                    "materi" : materi,
    ...
    return (
        <SafeAreaView style={style.bungkus}>
            <View style={style.form} >
                <View>
                    <Text style={style.tittle}>FORM MATERI SEKOLAH SMP</Text>
                </View>
