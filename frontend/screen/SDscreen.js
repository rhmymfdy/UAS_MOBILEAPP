    ...
    return ( 
        <SafeAreaView style={style.body}>
           ...
           <View style={style.margin}>
                <TouchableOpacity onPress={() => navigation.navigate('InputSD')}>
                        <View style={style.bungkus}>
                            <Image style ={style.logo} source={require('../assets/input.png')}/>
                            <Text>INPUT MATERI SD</Text>
                        </View>
                </TouchableOpacity>
                
                <TouchableOpacity onPress={() => navigation.navigate('BacaSD')}>
                        <View  style={style.bungkus}>
                            <Image style ={style.logo} source={require('../assets/book.png')}/>
                            <Text>BACA MATERI SD</Text>
                        </View>
                </TouchableOpacity>         
